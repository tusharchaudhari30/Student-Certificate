			...
			<div class="right_col" role="main">
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						<div class="x_panel">
						<c:choose>
						<c:when test="${student.current_year == 3}">
							<div class="x_title">
								<h2>Create LC</h2>
							...
							<div class="x_content">
								...
								<form:form commandName="student"
									...
									action="/StudentCampus/loginuser/lc/printnow">
									...
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12">LC Printed
											<span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<form:input path="LC" id="middle-name"
												class="form-control col-md-7 col-xs-12" type="text" readonly="true"/>
										</div>
									</div>
									<c:if test="${student.LC == 0}">
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12">Progress
											<span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<form:input path="progress" id="middle-name"
												class="form-control col-md-7 col-xs-12" type="text"/>
										</div>
									</div>
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12">Conduct
											<span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<form:input path="conduct" id="middle-name"
												class="form-control col-md-7 col-xs-12" type="text"/>
										</div>
									</div>
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12">Result Leave
											<span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<form:input path="result_leave" id="middle-name"
												class="form-control col-md-7 col-xs-12" type="text"/>
										</div>
									</div>
									<div class="form-group">
										<label for="middle-name"
											class="control-label col-md-3 col-sm-3 col-xs-12">Reason leave
											<span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<form:input path="reason_leave" id="middle-name"
												class="form-control col-md-7 col-xs-12" type="text"/>
										</div>
									</div>
							...
							<c:otherwise>
							<h1>Student is not elligible for LC</h1>
							</c:otherwise>
							</c:choose>
						</div>
					</div>
